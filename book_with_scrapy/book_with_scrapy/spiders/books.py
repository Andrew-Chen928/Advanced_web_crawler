...
class BooksSpider(Spider):
    ...
    # to scaping specific information (exp: category), we can define the constructor to assign the start_url,
    # and when you call the spider, add an argument for the category like this:
    ...
    def close(self, reason):
    	# example to rename the file using close function
